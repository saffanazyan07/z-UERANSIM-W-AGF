...
asn_TYPE_member_t asn_MBR_IABTNLAddressesRequested_1[] = {
	{ ATF_POINTER, 5, offsetof(struct IABTNLAddressesRequested, tNLAddressesOrPrefixesRequestedAllTraffic),
		...
		0,
		{ 0, &asn_PER_memb_tNLAddressesOrPrefixesRequestedAllTraffic_constr_2,  memb_tNLAddressesOrPrefixesRequestedAllTraffic_constraint_1 },
	...
	{ ATF_POINTER, 4, offsetof(struct IABTNLAddressesRequested, tNLAddressesOrPrefixesRequestedF1_C),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_tNLAddressesOrPrefixesRequestedF1_C_constr_3,  memb_tNLAddressesOrPrefixesRequestedF1_C_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 3, offsetof(struct IABTNLAddressesRequested, tNLAddressesOrPrefixesRequestedF1_U),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_tNLAddressesOrPrefixesRequestedF1_U_constr_4,  memb_tNLAddressesOrPrefixesRequestedF1_U_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct IABTNLAddressesRequested, tNLAddressesOrPrefixesRequestedNoNF1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_tNLAddressesOrPrefixesRequestedNoNF1_constr_5,  memb_tNLAddressesOrPrefixesRequestedNoNF1_constraint_1 },
		0, 0, /* No default value */
