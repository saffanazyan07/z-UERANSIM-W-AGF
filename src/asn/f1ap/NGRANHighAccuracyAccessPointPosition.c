...
static asn_oer_constraints_t asn_OER_memb_uncertaintySemi_major_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_uncertaintySemi_minor_constr_6 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_orientationOfMajorAxis_constr_7 CC_NOTUSED = {
	{ 1, 1 }	/* (0..179) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_horizontalConfidence_constr_8 CC_NOTUSED = {
	{ 1, 1 }	/* (0..100) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_uncertaintyAltitude_constr_9 CC_NOTUSED = {
	{ 1, 1 }	/* (0..255) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_verticalConfidence_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (0..100) */,
	-1};
...
asn_TYPE_member_t asn_MBR_NGRANHighAccuracyAccessPointPosition_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGRANHighAccuracyAccessPointPosition, uncertaintySemi_major),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncertaintySemi_major_constr_5, &asn_PER_memb_uncertaintySemi_major_constr_5,  memb_uncertaintySemi_major_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGRANHighAccuracyAccessPointPosition, uncertaintySemi_minor),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncertaintySemi_minor_constr_6, &asn_PER_memb_uncertaintySemi_minor_constr_6,  memb_uncertaintySemi_minor_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGRANHighAccuracyAccessPointPosition, orientationOfMajorAxis),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_orientationOfMajorAxis_constr_7, &asn_PER_memb_orientationOfMajorAxis_constr_7,  memb_orientationOfMajorAxis_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGRANHighAccuracyAccessPointPosition, horizontalConfidence),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_horizontalConfidence_constr_8, &asn_PER_memb_horizontalConfidence_constr_8,  memb_horizontalConfidence_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGRANHighAccuracyAccessPointPosition, uncertaintyAltitude),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_uncertaintyAltitude_constr_9, &asn_PER_memb_uncertaintyAltitude_constr_9,  memb_uncertaintyAltitude_constraint_1 },
		0, 0, /* No default value */
		"uncertaintyAltitude"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NGRANHighAccuracyAccessPointPosition, verticalConfidence),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_verticalConfidence_constr_10, &asn_PER_memb_verticalConfidence_constr_10,  memb_verticalConfidence_constraint_1 },
		0, 0, /* No default value */
		"verticalConfidence"
		},
