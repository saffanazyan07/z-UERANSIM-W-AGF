...
static asn_TYPE_member_t asn_MBR_ConditionalInterDUMobilityInformation_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_ConditionalInterDUMobilityInformation_specs_1 = {
