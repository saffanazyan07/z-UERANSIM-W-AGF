 ...
 */
static asn_oer_constraints_t asn_OER_type_M5_Links_to_log_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_M5_Links_to_log = {
	...
	sizeof(asn_DEF_M5_Links_to_log_tags_1)
		/sizeof(asn_DEF_M5_Links_to_log_tags_1[0]), /* 1 */
	{ &asn_OER_type_M5_Links_to_log_constr_1, &asn_PER_type_M5_Links_to_log_constr_1, NativeEnumerated_constraint },
