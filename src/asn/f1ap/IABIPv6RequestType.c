...
static asn_oer_constraints_t asn_OER_type_IABIPv6RequestType_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_TYPE_member_t asn_MBR_IABIPv6RequestType_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct IABIPv6RequestType, choice.iPv6Address),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct IABIPv6RequestType, choice.iPv6Prefix),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct IABIPv6RequestType, choice.choice_extension),
...
asn_TYPE_descriptor_t asn_DEF_IABIPv6RequestType = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_IABIPv6RequestType_constr_1, &asn_PER_type_IABIPv6RequestType_constr_1, CHOICE_constraint },
