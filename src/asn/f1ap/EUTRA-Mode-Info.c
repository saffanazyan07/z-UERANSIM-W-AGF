...
asn_TYPE_member_t asn_MBR_EUTRA_Mode_Info_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Mode_Info, choice.eUTRAFDD),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Mode_Info, choice.eUTRATDD),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Mode_Info, choice.choice_extension),
