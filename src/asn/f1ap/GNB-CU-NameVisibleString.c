 ...
 */
static asn_oer_constraints_t asn_OER_type_GNB_CU_NameVisibleString_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_TYPE_descriptor_t asn_DEF_GNB_CU_NameVisibleString = {
	...
	sizeof(asn_DEF_GNB_CU_NameVisibleString_tags_1)
		/sizeof(asn_DEF_GNB_CU_NameVisibleString_tags_1[0]), /* 1 */
	{ &asn_OER_type_GNB_CU_NameVisibleString_constr_1, &asn_PER_type_GNB_CU_NameVisibleString_constr_1, GNB_CU_NameVisibleString_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
