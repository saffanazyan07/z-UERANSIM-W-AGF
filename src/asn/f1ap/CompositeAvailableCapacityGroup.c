...
asn_TYPE_member_t asn_MBR_CompositeAvailableCapacityGroup_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CompositeAvailableCapacityGroup, compositeAvailableCapacityDownlink),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CompositeAvailableCapacityGroup, compositeAvailableCapacityUplink),
