...
asn_TYPE_member_t asn_MBR_NumDLULSymbols_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NumDLULSymbols, numDLSymbols),
		...
		0,
		{ &asn_OER_memb_numDLSymbols_constr_2, &asn_PER_memb_numDLSymbols_constr_2,  memb_numDLSymbols_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NumDLULSymbols, numULSymbols),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_numULSymbols_constr_3, &asn_PER_memb_numULSymbols_constr_3,  memb_numULSymbols_constraint_1 },
		0, 0, /* No default value */
		"numULSymbols"
		},
