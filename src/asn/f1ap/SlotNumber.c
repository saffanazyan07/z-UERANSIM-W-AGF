...
int
SlotNumber_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static asn_per_constraints_t asn_PER_type_SlotNumber_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_SlotNumber = {
	...
	sizeof(asn_DEF_SlotNumber_tags_1)
		/sizeof(asn_DEF_SlotNumber_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_SlotNumber_constr_1, SlotNumber_constraint },
	0, 0,	/* No members */
	0	/* No specifics */
};
