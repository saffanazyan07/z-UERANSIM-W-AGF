...
static asn_oer_constraints_t asn_OER_type_nrofSymbols_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_groupOrSequenceHopping_constr_13 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_startPosition_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (0..13) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_freqDomainShift_constr_11 CC_NOTUSED = {
	{ 2, 1 }	/* (0..268) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_c_SRS_constr_12 CC_NOTUSED = {
	{ 1, 1 }	/* (0..63) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_sequenceId_constr_18 CC_NOTUSED = {
	{ 2, 1 }	/* (0..65535) */,
	-1};
...
asn_TYPE_descriptor_t asn_DEF_nrofSymbols_5 = {
	...
	{ &asn_OER_type_nrofSymbols_constr_5, &asn_PER_type_nrofSymbols_constr_5, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_groupOrSequenceHopping_13 = {
	...
	{ &asn_OER_type_groupOrSequenceHopping_constr_13, &asn_PER_type_groupOrSequenceHopping_constr_13, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_PosSRSResource_Item_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PosSRSResource_Item, startPosition),
		...
		0,
		{ &asn_OER_memb_startPosition_constr_4, &asn_PER_memb_startPosition_constr_4,  memb_startPosition_constraint_1 },
		0, 0, /* No default value */
		"startPosition"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PosSRSResource_Item, freqDomainShift),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_freqDomainShift_constr_11, &asn_PER_memb_freqDomainShift_constr_11,  memb_freqDomainShift_constraint_1 },
		0, 0, /* No default value */
		"freqDomainShift"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct PosSRSResource_Item, c_SRS),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_c_SRS_constr_12, &asn_PER_memb_c_SRS_constr_12,  memb_c_SRS_constraint_1 },
		0, 0, /* No default value */
		"c-SRS"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PosSRSResource_Item, sequenceId),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_sequenceId_constr_18, &asn_PER_memb_sequenceId_constr_18,  memb_sequenceId_constraint_1 },
		0, 0, /* No default value */
		"sequenceId"
		},
