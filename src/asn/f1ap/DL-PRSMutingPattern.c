...
static asn_oer_constraints_t asn_OER_memb_two_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	2	/* (SIZE(2..2)) */};
...
static asn_oer_constraints_t asn_OER_memb_four_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	4	/* (SIZE(4..4)) */};
...
static asn_oer_constraints_t asn_OER_memb_six_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	6	/* (SIZE(6..6)) */};
...
static asn_oer_constraints_t asn_OER_memb_eight_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	8	/* (SIZE(8..8)) */};
...
static asn_oer_constraints_t asn_OER_memb_sixteen_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
static asn_oer_constraints_t asn_OER_memb_thirty_two_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	32	/* (SIZE(32..32)) */};
...
static asn_oer_constraints_t asn_OER_type_DL_PRSMutingPattern_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_DL_PRSMutingPattern_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DL_PRSMutingPattern, choice.two),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_two_constr_2, &asn_PER_memb_two_constr_2,  memb_two_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_PRSMutingPattern, choice.four),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_four_constr_3, &asn_PER_memb_four_constr_3,  memb_four_constraint_1 },
		0, 0, /* No default value */
		"four"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DL_PRSMutingPattern, choice.six),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_six_constr_4, &asn_PER_memb_six_constr_4,  memb_six_constraint_1 },
		0, 0, /* No default value */
		"six"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DL_PRSMutingPattern, choice.eight),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_eight_constr_5, &asn_PER_memb_eight_constr_5,  memb_eight_constraint_1 },
		0, 0, /* No default value */
		"eight"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DL_PRSMutingPattern, choice.sixteen),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_sixteen_constr_6, &asn_PER_memb_sixteen_constr_6,  memb_sixteen_constraint_1 },
		0, 0, /* No default value */
		"sixteen"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DL_PRSMutingPattern, choice.thirty_two),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_thirty_two_constr_7, &asn_PER_memb_thirty_two_constr_7,  memb_thirty_two_constraint_1 },
		0, 0, /* No default value */
		"thirty-two"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DL_PRSMutingPattern, choice.choice_extension),
...
asn_TYPE_descriptor_t asn_DEF_DL_PRSMutingPattern = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_DL_PRSMutingPattern_constr_1, &asn_PER_type_DL_PRSMutingPattern_constr_1, CHOICE_constraint },
