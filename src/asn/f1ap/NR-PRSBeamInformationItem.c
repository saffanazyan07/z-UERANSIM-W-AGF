...
static int
memb_pRSResourceSetID_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_pRSResourceSetID_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (0..7) */,
	-1};
static asn_per_constraints_t asn_PER_memb_pRSResourceSetID_constr_2 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_NR_PRSBeamInformationItem_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NR_PRSBeamInformationItem, pRSResourceSetID),
		...
		0,
		{ &asn_OER_memb_pRSResourceSetID_constr_2, &asn_PER_memb_pRSResourceSetID_constr_2,  memb_pRSResourceSetID_constraint_1 },
