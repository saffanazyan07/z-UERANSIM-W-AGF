...
asn_TYPE_member_t asn_MBR_PRSMuting_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PRSMuting, pRSMutingOption1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRSMuting, pRSMutingOption2),
	...
	{ ATF_POINTER, 1, offsetof(struct PRSMuting, iE_Extensions),
