...
static asn_oer_constraints_t asn_OER_memb_k1_constr_3 CC_NOTUSED = {
	{ 4, 1 }	/* (0..985025) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_k2_constr_4 CC_NOTUSED = {
	{ 4, 1 }	/* (0..492513) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_k3_constr_5 CC_NOTUSED = {
	{ 4, 1 }	/* (0..246257) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_k4_constr_6 CC_NOTUSED = {
	{ 4, 1 }	/* (0..123129) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_k5_constr_7 CC_NOTUSED = {
	{ 2, 1 }	/* (0..61565) */,
	-1};
...
static asn_oer_constraints_t asn_OER_type_GNBRxTxTimeDiffMeas_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_GNBRxTxTimeDiffMeas_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GNBRxTxTimeDiffMeas, choice.k1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_k1_constr_3, &asn_PER_memb_k1_constr_3,  memb_k1_constraint_1 },
		0, 0, /* No default value */
		"k1"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNBRxTxTimeDiffMeas, choice.k2),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_k2_constr_4, &asn_PER_memb_k2_constr_4,  memb_k2_constraint_1 },
		0, 0, /* No default value */
		"k2"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNBRxTxTimeDiffMeas, choice.k3),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_k3_constr_5, &asn_PER_memb_k3_constr_5,  memb_k3_constraint_1 },
		0, 0, /* No default value */
		"k3"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNBRxTxTimeDiffMeas, choice.k4),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_k4_constr_6, &asn_PER_memb_k4_constr_6,  memb_k4_constraint_1 },
		0, 0, /* No default value */
		"k4"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNBRxTxTimeDiffMeas, choice.k5),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_k5_constr_7, &asn_PER_memb_k5_constr_7,  memb_k5_constraint_1 },
		0, 0, /* No default value */
		"k5"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct GNBRxTxTimeDiffMeas, choice.choice_extension),
...
asn_TYPE_descriptor_t asn_DEF_GNBRxTxTimeDiffMeas = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_GNBRxTxTimeDiffMeas_constr_1, &asn_PER_type_GNBRxTxTimeDiffMeas_constr_1, CHOICE_constraint },
