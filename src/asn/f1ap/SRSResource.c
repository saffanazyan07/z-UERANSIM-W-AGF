...
asn_TYPE_descriptor_t asn_DEF_repetitionFactor_13 = {
	...
	{ 0, &asn_PER_type_repetitionFactor_constr_13, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_groupOrSequenceHopping_22 = {
	...
	{ 0, &asn_PER_type_groupOrSequenceHopping_constr_22, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_SRSResource_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRSResource, freqDomainPosition),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_freqDomainPosition_constr_17,  memb_freqDomainPosition_constraint_1 },
		0, 0, /* No default value */
		"freqDomainPosition"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRSResource, freqDomainShift),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_freqDomainShift_constr_18,  memb_freqDomainShift_constraint_1 },
		0, 0, /* No default value */
		"freqDomainShift"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRSResource, sequenceId),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sequenceId_constr_27,  memb_sequenceId_constraint_1 },
		0, 0, /* No default value */
		"sequenceId"
		},
