...
asn_TYPE_member_t asn_MBR_PathlossReferenceSignal_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PathlossReferenceSignal, choice.sSB),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PathlossReferenceSignal, choice.dL_PRS),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PathlossReferenceSignal, choice.choice_extension),
...
asn_TYPE_descriptor_t asn_DEF_PathlossReferenceSignal = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_PathlossReferenceSignal_constr_1, &asn_PER_type_PathlossReferenceSignal_constr_1, CHOICE_constraint },
