...
/* extern asn_TYPE_descriptor_t asn_DEF_nRCP_8;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_nRDLULTxPeriodicity_12;	// (Use -fall-defs-global to expose) */
