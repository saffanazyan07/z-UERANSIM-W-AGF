...
asn_TYPE_member_t asn_MBR_SRSConfig_1[] = {
	{ ATF_POINTER, 5, offsetof(struct SRSConfig, sRSResource_List),
	...
	{ ATF_POINTER, 4, offsetof(struct SRSConfig, posSRSResource_List),
	...
	{ ATF_POINTER, 3, offsetof(struct SRSConfig, sRSResourceSet_List),
	...
	{ ATF_POINTER, 2, offsetof(struct SRSConfig, posSRSResourceSet_List),
	...
	{ ATF_POINTER, 1, offsetof(struct SRSConfig, iE_Extensions),
