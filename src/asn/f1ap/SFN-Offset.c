...
static asn_TYPE_member_t asn_MBR_SFN_Offset_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SFN_Offset, sFN_Time_Offset),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_sFN_Time_Offset_constr_2,  memb_sFN_Time_Offset_constraint_1 },
...
static asn_SEQUENCE_specifics_t asn_SPC_SFN_Offset_specs_1 = {
