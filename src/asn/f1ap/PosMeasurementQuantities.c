...
static asn_oer_constraints_t asn_OER_type_PosMeasurementQuantities_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16384)) */};
static asn_per_constraints_t asn_PER_type_PosMeasurementQuantities_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 14,  14,  1,  16384 }	/* (SIZE(1..16384)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_PosMeasurementQuantities_1[] = {
	{ ATF_POINTER, 0, 0,
...
static asn_SET_OF_specifics_t asn_SPC_PosMeasurementQuantities_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_PosMeasurementQuantities = {
	...
	sizeof(asn_DEF_PosMeasurementQuantities_tags_1)
		/sizeof(asn_DEF_PosMeasurementQuantities_tags_1[0]), /* 1 */
	{ &asn_OER_type_PosMeasurementQuantities_constr_1, &asn_PER_type_PosMeasurementQuantities_constr_1, SEQUENCE_OF_constraint },
