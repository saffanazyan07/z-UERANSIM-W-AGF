...
static asn_oer_constraints_t asn_OER_type_restrictedSetConfig_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_restrictedSetConfig_3 = {
	...
	{ &asn_OER_type_restrictedSetConfig_constr_3, &asn_PER_type_restrictedSetConfig_constr_3, NativeEnumerated_constraint },
