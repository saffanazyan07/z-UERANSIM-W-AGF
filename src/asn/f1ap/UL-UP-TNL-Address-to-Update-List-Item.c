...
static asn_TYPE_member_t asn_MBR_UL_UP_TNL_Address_to_Update_List_Item_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_UL_UP_TNL_Address_to_Update_List_Item_specs_1 = {
