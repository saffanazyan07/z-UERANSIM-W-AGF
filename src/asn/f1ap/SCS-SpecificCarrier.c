...
static asn_per_constraints_t asn_PER_memb_carrierBandwidth_constr_9 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_SCS_SpecificCarrier_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SCS_SpecificCarrier, carrierBandwidth),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_carrierBandwidth_constr_9,  memb_carrierBandwidth_constraint_1 },
		0, 0, /* No default value */
		"carrierBandwidth"
		},
