...
static asn_oer_constraints_t asn_OER_type_PeriodicityList_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..16)) */};
...
asn_SET_OF_specifics_t asn_SPC_PeriodicityList_specs_1 = {
	sizeof(struct PeriodicityList),
	offsetof(struct PeriodicityList, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_PeriodicityList = {
	...
	sizeof(asn_DEF_PeriodicityList_tags_1)
		/sizeof(asn_DEF_PeriodicityList_tags_1[0]), /* 1 */
	{ &asn_OER_type_PeriodicityList_constr_1, &asn_PER_type_PeriodicityList_constr_1, SEQUENCE_OF_constraint },
