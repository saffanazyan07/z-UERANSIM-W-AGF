...
static asn_TYPE_member_t asn_MBR_PagingIdentity_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PagingIdentity, choice.rANUEPagingIdentity),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PagingIdentity, choice.cNUEPagingIdentity),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PagingIdentity, choice.choice_extension),
