...
asn_TYPE_member_t asn_MBR_GeographicalCoordinates_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GeographicalCoordinates, tRPPositionDefinitionType),
	...
	{ ATF_POINTER, 2, offsetof(struct GeographicalCoordinates, dLPRSResourceCoordinates),
...
static const int asn_MAP_GeographicalCoordinates_oms_1[] = { 1, 2 };
...
asn_SEQUENCE_specifics_t asn_SPC_GeographicalCoordinates_specs_1 = {
